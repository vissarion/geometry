...
struct sectionalize_part
{
                             ...
                             std::size_t max_count)
    {
        ...
        geometry::recalculate(previous_robust_point, *it);
            ...
            ++previous, ++it, index++)
        {
            ...
            geometry::recalculate(current_robust_point, *it);
...
struct sectionalize_range
{
                             ...
                             std::size_t max_count)
    {
        ...
        sectionalize_part<DimensionVector>::apply(sections, boost::begin(view), boost::end(view),
...
struct sectionalize_polygon
{
                ...
                std::size_t max_count)
    {
        ...
        sectionalizer::apply(exterior_ring(poly), sections, strategy, ring_id, max_count);
