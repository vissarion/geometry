...
public:
    ...
    using intersection_point_type = int;
    using intersection_policy_type = int;

    using result_type = int;

    using side_calculator_type = side_calculator<UniqueSubRange1, UniqueSubRange2, UmbrellaStrategy>;

    using swapped_side_calculator_type = side_calculator<UniqueSubRange2, UniqueSubRange1, UmbrellaStrategy>;
...
{
    using base = intersection_info_base<UniqueSubRange1, UniqueSubRange2, TurnPoint, UmbrellaStrategy>;
